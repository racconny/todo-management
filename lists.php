...
<head>
    ...
    <script defer src="script_lists.js"></script>
           ...
           $stat = $db->getListStat($lists[$i]['id']); 
            ...
            <div class="list-title">'.$lists[$i]['name'].'</div>
                ...
                <div class="bottom-panel">
                    <button class="inv-button delete-btn" data-id="'.$lists[$i]['id'].'" style="color: #58aeff">
                        <span class="fas fa-trash"></span>
                    </button>
                    <button class="inv-button edit-btn" data-id="'.$lists[$i]['id'].'">
